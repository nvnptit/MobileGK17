...
public class chamCongActivity extends AppCompatActivity {
    ...
    private void setEvent() {
        database = new ChamCongDB(chamCongActivity.this);
        chiTietChamCongDB = new ChiTietChamCongDB(chamCongActivity.this);
    ...
    private boolean lvDanhSachOnLongItemClickEvent(AdapterView<?> adapterView, View view, int i, long l) {
        ChamCong chamCong = data.get(i);
        Intent intent = new Intent(chamCongActivity.this, ChiTietChamCongActivity.class);
